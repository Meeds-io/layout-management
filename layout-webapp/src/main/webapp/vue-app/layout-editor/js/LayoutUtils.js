...
export function applyContainerStyle(container, containerStyle) {
  ...
  if (container.template === flexTemplate || container.template === gridTemplate) {
    Vue.set(container, 'marginTop', containerStyle.marginTop || 0);
    Vue.set(container, 'marginRight', containerStyle.marginRight || 0);
    Vue.set(container, 'marginBottom', containerStyle.marginBottom || 0);
    Vue.set(container, 'marginLeft', containerStyle.marginLeft || 0);
  } else {
