...
export function getStyle(container, options) {
  ...
  if (!options.noBackgroundStyle
    ...
    if (container.backgroundColor) {
      if (options.pageStyle) {
        style['--pageBackgroundColor'] = container.backgroundColor;
      ...
      if (options.pageStyle) {
        style['--pageBackgroundColor'] = 'transparent';
      } else if (options.sectionStyle) {
    ...
    if (container.backgroundEffect && container.backgroundImage) {
      ...
      if (options.pageStyle) {
        style['--pageBackgroundImage'] = `url(${container.backgroundImage})`;
      } else {
      ...
      if (options.pageStyle) {
        style['--pageBackgroundImage'] = container.backgroundEffect;
      } else {
      ...
      if (options.pageStyle) {
        style['--pageBackgroundImage'] = 'none';
        style['--pageBackgroundRepeat'] = 'no-repeat';
        style['--pageBackgroundSize'] = 'unset';
        style['--pageBackgroundPosition'] = 'unset';
      } else {
    ...
    if (container.backgroundImage) {
      if (container.backgroundRepeat) {
        if (options.pageStyle) {
          style['--pageBackgroundRepeat'] = container.backgroundRepeat;
        } else {
      ...
      if (container.backgroundSize) {
        if (options.pageStyle) {
          style['--pageBackgroundSize'] = container.backgroundSize;
        } else {
      ...
      if (container.backgroundPosition) {
        if (options.pageStyle) {
          style['--pageBackgroundPosition'] = container.backgroundPosition;
        } else {
