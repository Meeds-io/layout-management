    ...
    <template v-if="drawer" #content>
      <v-card
        ...
        <template v-if="show">
          ...
          <div v-if="isTopBanner" class="d-flex align-center mb-2">
            <div class="me-auto mb-2">
...
export default {
  ...
  computed: {
    ...
    title() {
      return this.isTopBanner ? this.$t('layout.editSiteBannerSection.label.editSiteTopbarSection') : this.$t('layout.editSiteBannerSection.label.editSiteBottomSection');
    },
  },
  created() {
  ...
  methods: {
    open(container) {
      ...
      this.height = this.container.height || 150;
      this.show = true;
